...
{
    /// <summary>
    /// Constants defined by Microsoft regarding Win32 stuff
    /// </summary>
    [CLSCompliant(false)]
    [SuppressMessage("ReSharper", "InconsistentNaming")]
    [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "Names taken from MSDN")]
    public static class Win32Constants
    {
        #region Window Messages

        /// <summary>
        /// The WM_NULL message performs no operation. An application sends the WM_NULL message if it wants 
        ...
        /// The window procedure of the new window receives this message after the window is created, but 
        ...
        /// <summary>
        /// An application sends a WM_GETTEXTLENGTH message to determine the length, in characters, of the 
        ...
        /// 
        /// Note  The WM_WININICHANGE message is provided only for compatibility with earlier versions of the 
        ...
        /// <summary>
        /// The WM_DEVMODECHANGE message is sent to all top-level windows whenever the user changes device-mode 
        /// settings. 
        /// </summary>
        public const uint WM_DEVMODECHANGE = 0x001B;
        
        /// <summary>
        /// The WM_ACTIVATEAPP message is sent when a window belonging to a different application than the 
        /// active window is about to be activated. The message is sent to the application whose window is 
        ...
        /// <summary>
        /// The WM_CANCELMODE message is sent to cancel certain modes, such as mouse capture. For example, 
        /// the system sends this message to the active window when a dialog box or message box is displayed. 
        /// Certain functions also send this message explicitly to the specified window regardless of whether 
        /// it is the active window. For example, the EnableWindow function sends this message when disabling
        /// the specified window.
        /// </summary>
        public const uint WM_CANCELMODE = 0x001F;
        
        /// <summary>
        /// The WM_SETCURSOR message is sent to a window if the mouse causes the cursor to move within a window 
        /// and mouse input is not captured. 
        /// </summary>
        public const uint WM_SETCURSOR = 0x0020;

        /// <summary>
        /// The WM_MOUSEACTIVATE message is sent when the cursor is in an inactive window and the user presses
        /// a mouse button. The parent window receives this message only if the child window passes it to the 
        /// DefWindowProc function.
        /// </summary>
        public const uint WM_MOUSEACTIVATE = 0x0021;
        
        /// <summary>
        /// The WM_CHILDACTIVATE message is sent to a child window when the user clicks the window's title bar 
        ...
        /// <summary>
        /// Windows NT 3.51 and earlier: The WM_PAINTICON message is sent to a minimized window when the icon 
        /// is to be painted. This message is not sent by newer versions of Microsoft Windows, except in unusual 
        ...
        /// <summary>
        /// The WM_SPOOLERSTATUS message is sent from Print Manager whenever a job is added to or removed from 
        ...
        /// <summary>
        /// Sent to the owner of a list box or combo box when the list box or combo box is destroyed or when 
        /// items are removed by the LB_DELETESTRING, LB_RESETCONTENT, CB_DELETESTRING, or CB_RESETCONTENT 
        /// message. The system sends a WM_DELETEITEM message for each deleted item. The system sends the WM_DELETEITEM message for any deleted list box or combo box item with nonzero item data.
        /// </summary>
        public const uint WM_DELETEITEM = 0x002D;
        
        /// <summary>
        /// Sent by a list box with the LBS_WANTKEYBOARDINPUT style to its owner in response to a WM_KEYDOWN 
        /// message. 
        /// </summary>
        ...
        /// <summary>
        /// Notifies applications that the system, typically a battery-powered personal computer, is about to 
        /// enter a suspended mode.
        /// The WM_POWER message is obsolete. It is provided only for compatibility with 16-bit Windows-based 
        /// applications. Applications should use the WM_POWERBROADCAST message.
        /// Use: POWERBROADCAST
        /// </summary>
        [Obsolete("Applications should use the WM_POWERBROADCAST.")]
        ...
        /// <summary>
        /// Error Access Denied RC
        /// </summary>
        public const int ERROR_ACCESS_DENIED = 5;

        /// <summary>
        /// Error invalid level RC
        /// </summary>
